            ...
            <div class="row">
                <div class="col-12 col-md-4">
                    <div class="mb-3">
                        ...
                        <input id="name" name="name" type="text" class="form-control" placeholder="e.g. Manager" value="{{ $role->name }}"/>
                    </div>
                </div>
                <h3>Permissions</h3>
                ...
                <div class="col-12 col-md-4">
                    <div class="form-check mb-3">
                        ...
                        @if(in_array($permission->id, $role->permissions->pluck('id')->toArray())) checked @endif
                         name="permissions[]" type="checkbox" class="form-check-input" value="{{ $permission->id }}"
                       />
